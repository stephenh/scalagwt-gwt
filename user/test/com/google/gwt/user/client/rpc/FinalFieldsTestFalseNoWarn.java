...
/**
 * Test Serializing final fields in RPC when property rpc.final.serialize
 * set to false_nowarn, we should not serialize final fields, but no warn
 * should be generated
 */
public class FinalFieldsTestFalseNoWarn extends RpcTestBase {
  ...
  public String getModuleName() {
    return "com.google.gwt.user.RPCFinalFieldsTestFalseNoWarn";
  }
